...
namespace UIWidgets
{
	...
	[Serializable]
	public class REListViewItemTemplate<TItemView>
		where TItemView : REListViewItem
	{
		...
		[SerializeField]
		private UIWidgets.InstanceID templateID;

		/// <summary>
		/// Template ID.
		/// </summary>
		public UIWidgets.InstanceID TemplateID
		{
			get
			{
				return templateID;
		...
		/// </summary>
		protected REListViewItemTemplate()
		{
		}
		...
		public static TTemplate Create<TTemplate>(TItemView template)
			where TTemplate : REListViewItemTemplate<TItemView>, new()
		{
		...
		public UIWidgets.PoolEnumerator<TItemView> GetEnumerator(InstanceID ownerID, UIWidgets.PoolEnumeratorMode mode)
		{
			return new UIWidgets.PoolEnumerator<TItemView>(
				mode, Template, Instances.Of(ownerID), Cache);
		}
		...
		protected virtual Vector2 GetSize()
		{
			...
			RECompatibility.GetComponents<ILayoutElement>(Template.gameObject, LayoutElements);
		...
		/// <param name="ownerID">Owner ID.</param>
		public virtual void RequestInstances(REListViewCustomBase owner, InstanceID ownerID)
		{
...
#pragma warning disable 0618
				var disable_recycling = component.DisableRecycling;
#pragma warning restore 0618
		...
		protected virtual TItemView Create(REListViewCustomBase owner, InstanceID ownerID)
		{
			TItemView instance;
			...
			{
				instance = RECompatibility.Instantiate(Template, owner.Container);
		...
		public virtual bool Require(REListViewCustomBase owner, InstanceID ownerID, int index, Func<int, TItemView, bool> instanceCompare)
		{
			RequiredInstances += 1;
		...
		/// </summary>
		/// <param name="action">Action.</param>
		public void ForEachCache(Action<REListViewItem> action)
		{
			action(Template);
		...
		public virtual void CopyFrom(REListViewItemTemplate<TItemView> template, bool includeCache = true)
		{
			if (includeCache)
			{
		...
		/// </summary>
		/// <param name="owner">Owner.</param>
		public void SetOwner(REListViewCustomBase owner)
		{
